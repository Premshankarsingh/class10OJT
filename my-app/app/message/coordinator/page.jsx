...
const DEFAULT_MESSAGE = {
  ...
  message: "We believe in nurturing young minds to become future leaders through innovative learning.",
  ...
  useEffect(() => {
    fetch("/api/cms/messages")
      .then((r) => {
        ...
        if (res && res.success && res.data?.coordinator) setMessage(res.data.coordinator);
      }).catch((err) => console.error("Coordinator message fetch error:", err.message));
  }, []);
            ...
            <Grid container spacing={4} alignItems="center">
              <Grid size={{ xs: 12, md: 4 }}>
                <Box display="flex" justifyContent="center">
                  <ImageStyle src={message.photo} alt="Coordinator" />
                </Box>
              </Grid>
              <Grid size={{ xs: 12, md: 8 }}>
                <Typography variant="h4" sx={{ fontWeight: 800, color: "#27ae60", mb: 1 }}>

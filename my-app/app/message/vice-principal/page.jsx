...
const DEFAULT_MESSAGE = {
  ...
  message: "Our community thrives on collaboration, ensuring every student reaches their potential.",
...
export default function VicePrincipalMessage() {
  ...
  useEffect(() => {
    fetch("/api/cms/messages")
      .then((r) => {
        ...
        if (res && res.success && res.data?.vicePrincipal) setMessage(res.data.vicePrincipal);
      }).catch((err) => console.error("VicePrincipal message fetch error:", err.message));
  }, []);
            ...
            <Grid container spacing={4} alignItems="center">
              <Grid size={{ xs: 12, md: 4 }}>
                <Box display="flex" justifyContent="center">
                  <ImageStyle src={message.photo} alt="Vice Principal" />
                </Box>
              </Grid>
              <Grid size={{ xs: 12, md: 8 }}>
                <Typography variant="h4" sx={{ fontWeight: 800, color: "#0984e3", mb: 1 }}>
